...
import HeaderLogo from "../LeadbullLogo";
const Header = () => {
    const [open, setOpen] = useState(false);
    return (
        <>
            <header className="lg:container bg-black sticky top-0 z-10">
                <div className="flex items-center justify-between lg:justify-normal flex-wrap lg:flex-nowrap py-1 px-5 sm:px-6 md:px-8 lg:px-0 mt-6 relative">
                    <HeaderLogo className="w-36 md:w-40 lg:w-44 xl:w-56" />
